...
Find out *why* the above indicates the increases or decreases in share price...
...
The subset argument means the data is filter in only to include the year 2018.
